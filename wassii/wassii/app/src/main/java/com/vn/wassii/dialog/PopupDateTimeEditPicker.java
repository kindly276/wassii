 ...
 */
public class PopupDateTimeEditPicker extends Dialog {
    ...
    // Declare listener
    private OnPopupDateTimeEditListener listener;
    private int type;
    ...
    public PopupDateTimeEditPicker(MainActivity context, String des, OnPopupDateTimeEditListener listener, int type, Calendar calendar) {
        super(context);
...
//                Log.e("thaond", "Time" + dayOfWeek);
                String stringDay = getDayOfWeek(dayOfWeek);
    ...
    public interface OnPopupDateTimeEditListener {
