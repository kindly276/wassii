...
public class SlidingTabLayoutUser extends HorizontalScrollView {
	...
	private final SlidingTabStripUser mTabStrip;

	public SlidingTabLayoutUser(Context context) {
		this(context, null);
	}

	public SlidingTabLayoutUser(Context context, AttributeSet attrs) {
	...
	public SlidingTabLayoutUser(Context context, AttributeSet attrs,
		...
		mTabStrip = new SlidingTabStripUser(context);
	 ...
	 * {@link SlidingTabLayoutUser} you are required to set any
