...
public class SlidingTabStripUser extends LinearLayout {
	...
	private SlidingTabLayoutUser.TabColorizer mCustomTabColorizer;
	private final SimpleTabColorizer mDefaultTabColorizer;

	SlidingTabStripUser(Context context) {
		this(context, null);
	}

	SlidingTabStripUser(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		context.getTheme()
				.resolveAttribute(R.attr.colorPrimary, outValue, true);
	...
	void setCustomTabColorizer(SlidingTabLayoutUser.TabColorizer customTabColorizer) {
	...
	protected void onDraw(Canvas canvas) {
		...
		final SlidingTabLayoutUser.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer
				: mDefaultTabColorizer;
	...
	private static class SimpleTabColorizer implements
			SlidingTabLayoutUser.TabColorizer {
